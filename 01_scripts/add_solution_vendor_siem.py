...
def add_solution_of_venders_siem(cursor):
    vendor_name = input("Введите название solution: ")

    insert_query = """
    INSERT INTO solution_of_venders_siem (solution_of_venders)
    VALUES (%s)
    """
...
try:
    ...
    with connection.cursor() as cursor:
        ...
        create_table_query = """
        CREATE TABLE IF NOT EXISTS solution_of_venders_siem (
            siem_id INT AUTO_INCREMENT PRIMARY KEY,
        ...
        while True:
            add_solution_of_venders_siem(cursor)
