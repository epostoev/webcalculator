...
--
-- Table structure for table `norm_of_hour_avz_k3`
--

DROP TABLE IF EXISTS `norm_of_hour_avz_k3`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `norm_of_hour_avz_k3` (
